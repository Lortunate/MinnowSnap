...
use crate::core::capture::long_capture::{LongCaptureEvent, LongCaptureRuntime};
            ...
            for event in events {
                match event {
                    ...
                    LongCaptureEvent::Progress { height, preview_image } => {
                        ...
                        state.snapshot.preview_image = Some(render_image_from_rgba(preview_image));
                        changed = true;
                    }
