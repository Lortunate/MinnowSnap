...
impl OverlayView {
    ...
    pub(super) fn on_action_copy_pixel_color(&mut self, _: &CopyPixelColor, window: &mut Window, cx: &mut Context<Self>) {
        self.dispatch_command(
            crate::ui::features::overlay::state::OverlayCommand::Capture(CaptureCommand::CopyPickerColor),
            window,
            cx,
        );
    }
    ...
    annotation_action_handler!(
        ...
        SelectArrowTool,
        AnnotationCommand::SetTool(crate::ui::features::overlay::state::AnnotationTool::Arrow)
    );
    annotation_action_handler!(
        on_action_select_rectangle_tool,
        SelectRectangleTool,
        AnnotationCommand::SetTool(crate::ui::features::overlay::state::AnnotationTool::Rectangle)
    );
    annotation_action_handler!(
        on_action_select_circle_tool,
        SelectCircleTool,
        AnnotationCommand::SetTool(crate::ui::features::overlay::state::AnnotationTool::Circle)
    );
    annotation_action_handler!(
        on_action_select_counter_tool,
        SelectCounterTool,
        AnnotationCommand::SetTool(crate::ui::features::overlay::state::AnnotationTool::Counter)
    );
    annotation_action_handler!(
        on_action_select_text_tool,
        SelectTextTool,
        AnnotationCommand::SetTool(crate::ui::features::overlay::state::AnnotationTool::Text)
    );
    annotation_action_handler!(
        on_action_select_mosaic_tool,
        SelectMosaicTool,
        AnnotationCommand::SetTool(crate::ui::features::overlay::state::AnnotationTool::Mosaic)
    );
