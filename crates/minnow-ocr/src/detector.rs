...
use crate::preprocess::{PPOCR_MEAN, PPOCR_STD, create_onnx_session, get_bounding_rect, normalize_image};
use anyhow::Result;
    ...
    fn postprocess(&self, data: &[f32], out_w: usize, out_h: usize, orig_w: f32, orig_h: f32) -> Result<Vec<BoxPoints>> {
        ...
        let boxes: Vec<BoxPoints> = contours
            ...
            .filter_map(|contour| {
                ...
                let max_y_ex = (max_y as f32 + offset).min(out_h as f32);
                let x1 = (min_x_ex * scale_x) as i32;
                let y1 = (min_y_ex * scale_y) as i32;
                let x2 = (max_x_ex * scale_x) as i32;
                let y2 = (max_y_ex * scale_y) as i32;
