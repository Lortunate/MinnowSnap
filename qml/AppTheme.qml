...
QtObject {
    ...
    readonly property color switchTrackOff: isDark ? "#3A3A3C" : "#E5E5EA"
    readonly property color switchBorderOff: isDark ? "#505050" : "#D1D1D6"
    readonly property color inputFill: isDark ? "transparent" : "#0D000000"
    readonly property color contextMenuShadow: isDark ? "#80000000" : "#33000000"

    readonly property color handleFill: "#FFFFFF"
    readonly property color handleInner: "#000000"
    readonly property color handleShadow: "#4D000000"

    readonly property color selectionMask: "#66000000"
    
    readonly property color checkerboardDark: "#1A1A1A"
    readonly property color gridLine: "#30606060"

    // Shortcut Input
    readonly property color keyCapBackground: isDark ? "#3E3E42" : "#FFFFFF"
    readonly property color keyCapBorder: isDark ? "#505050" : "#D0D0D0"
    readonly property color keyCapShadow: isDark ? "#252526" : "#C0C0C0"
    readonly property color inputRecordingBg: isDark ? "#2A2A2A" : "#F5F5F5"
    readonly property color inputRecordingPulse: isDark ? "#353535" : "#EBEBEB"
    readonly property color iconButtonHover: isDark ? "#40FFFFFF" : "#20000000"
    readonly property int keyCapRadius: 4
    readonly property int keyCapHeight: 22
    readonly property int keyCapShadowHeight: 2
}
